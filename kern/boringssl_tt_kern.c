#ifndef ECAPTURE_BORINGSSL_TT_KERN_H
#define ECAPTURE_BORINGSSL_TT_KERN_H
...
// ssl_session_st->secret_length x
...
// bssl::SSL3_STATE->exporter_secret x
...
// bssl::SSL_HANDSHAKE->max_version x
